...
var Preview = /** @class */ (function () {
    ...
    Preview.prototype.preview = function () {
    };
...
var Selections = /** @class */ (function () {
    ...
    // Set tabs
    Selections.prototype.setActiveTab = function (item, type) {
    ...
    Selections.prototype.changeTextSide2 = function (lib) {
        var _this = this;
        if (lib) {
            this.textSide2.text = "";
    ...
    Selections.prototype.checkOverflow = function () {
        ...
        this.cloudinaryService.getCloudinary(src).subscribe(function (response) {
            ...
            switch (src) {
                ...
                case 'landscape':
                    ...
                    break;
                case 'quotes':
                    _this.listQuotes = _this.cloudinaryResponse;
                    break;
                case 'listPets':
                    _this.isPets = true;
                    _this.cloudinaryResponse.forEach(function (element) {
                        var mySubString = element.public_id.substring(element.public_id.lastIndexOf("/") + 1);
                        element.name = mySubString;
                        _this.listPets.push(element);
                    });
                    break;
                default:
                    break;
    ...
    Selections.prototype.listManImg = function () {
        ...
        this.cloudinaryResponse.forEach(function (element) {
            ...
            if (element.public_id.includes("shirt")) {
                if (_this.currentChar.gender === 'male') {
                    _this.listShirt = [
                        {
                ...
                if (_this.currentChar.gender === 'female') {
                    _this.listShirt = [
                        {
    ...
    Selections.prototype.changeGender = function (item, tabs) {
